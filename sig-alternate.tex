...
This paper will identify and discuss the downsides of Value-Oriented Software Development. In relation to this will it elaborate on appliance of activities from Continuous Experimentation to compensate for these drawbacks. Lastly will it describe the drawbacks which might come from this approach. 
\end{abstract}
